        ...
        <footer className="bg-brand-offWhite border-t border-brand-red/10 pt-16 pb-8 relative z-10">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-brand-dark font-bold mb-6">Platform</h4>
                        <ul className="space-y-3 text-brand-dark/70">
                            <li><Link to="/" className="hover:text-brand-red transition-colors">Home</Link></li>
                            <li><Link to="/apply-doctor" className="hover:text-brand-red transition-colors">Join as Doctor</Link></li>
                            <li><Link to="/login" className="hover:text-brand-red transition-colors">Patient Login</Link></li>
                            <li><Link to="/admin" className="hover:text-brand-red transition-colors">Admin Access</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-brand-dark/70">
                            ...
                            <li><a href="#" className="hover:text-brand-red transition-colors">Smart Contract</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-brand-red/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-4">
                        {/* Social Placeholders */}
                        <div className="w-8 h-8 rounded-full bg-white border border-brand-red/10 hover:bg-brand-red hover:text-white flex items-center justify-center transition-all cursor-pointer text-brand-dark/60 shadow-sm">
